...
@WebServlet({ "/giangvien/danhsachketqua", "/giangvien/danhsachketqua/index" })
public class Index extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        danhsach.removeIf(map -> {
            ...
            return !map.get("TenGiangVien").equals(
                    req.getSession().getAttribute("SS_HoTen"));
        });
        req.setAttribute("danhSachLopHocPhan", danhsach);
        req.getRequestDispatcher("/giangvien/danhsachketqua/index.jsp").forward(req, resp);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        resp.sendRedirect(req.getContextPath() + "/giangvien/danhsachlophocphan");
    }
}
