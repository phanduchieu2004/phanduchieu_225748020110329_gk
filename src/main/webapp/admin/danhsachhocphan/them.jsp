    ...
    <body>
      ...
      <main id="main" class="main">
        ...
        <div class="container shadow p-4">
          <form action="${pageContext.request.contextPath}/admin/danhsachhocphan/them" method="post">
            ...
            <div class="row">
              ...
              <div class="form-group col-md-6 mb-3">
                <label>Học kỳ</label>
                <input type="number" class="form-control" name="HocKy" value="${not empty HocKy ? HocKy : ''}" />
            ...
            <a class="btn btn-secondary" href="${pageContext.request.contextPath}/admin/danhsachhocphan">
              Quay lại
            </a>
