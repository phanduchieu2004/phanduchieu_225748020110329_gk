  ...
  <body>
    ...
    <main id="main" class="main">
      ...
      <div class="container shadow p-4">
        <form action="${pageContext.request.contextPath}/admin/danhsachlop/sua" method="post">
          <div class="row">
            <div class="form-group col-md-6 mb-3">
              <label>Mã lớp</label>
              <input type="text" class="form-control" name="MaLop" value="${lop.MaLop}" readonly />
            ...
            <div class="form-group col-md-6 mb-3">
              ...
              <input type="number" class="form-control" name="KhoaHoc" value="${lop.KhoaHoc}" />
            ...
            <div class="form-group col-md-6 mb-3">
              ...
              <select name="MaNganh" class="form-select">
                ...
                <c:forEach var="nganh" items="${danhSachNganh}">
                  <option value="${nganh.MaNganh}" <c:if test="${lop.MaNganh == nganh.MaNganh}">selected</c:if>>${nganh.TenNganh}</option>
                </c:forEach>
              </select>
