  ...
  <body>
    ...
    <main id="main" class="main">
      ...
      <div class="container shadow p-4">
        <form action="${pageContext.request.contextPath}/admin/danhsachtaikhoan/them" method="post">
          <div class="row">
            <div class="form-group col-md-6 mb-3">
              <label>Mã tài khoản</label>
              <input type="text" class="form-control" name="MaTaiKhoan" value="${not empty MaTaiKhoan ? MaTaiKhoan : ''}" />
              <c:if test="${not empty loiMaTaiKhoan}">
                <small class="text-danger">${loiMaTaiKhoan}</small>
              </c:if>
            </div>
            <div class="form-group col-md-6 mb-3">
            ...
            <div class="form-group col-md-6 mb-3">
              <label>Chức vụ</label>
              <input type="text" class="form-control" name="ChucVu" value="${not empty ChucVu ? ChucVu : ''}" />
            ...
            <div class="form-group col-md-6 mb-3">
              ...
              <input type="text" class="form-control" name="TrangThaiTaiKhoan" value="${not empty TrangThaiTaiKhoan ? TrangThaiTaiKhoan : ''}" />
